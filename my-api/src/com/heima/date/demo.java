...
public class demo {
    public static void main(String[] args) {
        // 1. 获取 Date 对象
        Date d1 = new Date();
        System.out.println(d1); // Tue Apr 25 17:12:05 CST 2017

        // 2. 获取指定时间的毫秒值
        Date d2 = new Date(0L); // 表示从 1970 年 1 月 1 日 00:00:00 开始经过 0L 毫秒后的时间
        long time = d2.getTime();
        System.out.println(time); // 1493138725000

        // 3. 获取时间原点之后一年的时间
        Date d3 = new Date(1000L * 60 * 60 * 24 * 365);
        System.out.println(d3); // Wed Apr 25 17:12:05 CST 2018
        ...
        System.out.println(s); // 2017-04-25 17:12:05
        ...
        try {
            d5 = sdf.parse(s1);
            System.out.println(d5); // Tue Apr 25 17:12:05 CST 2017
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 6.1 再转为 年月日 时分秒
        ...
        System.out.println(s2); // 2017年04月25日 17时12分05秒
